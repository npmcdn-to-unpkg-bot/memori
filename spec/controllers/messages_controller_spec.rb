  ...
  describe 'POST create' do
    context "sending emails" do
      ...
      it "sends out email to user with valid inputs" do
        post :create, memorial_id: Memorial.first.slug, message: { email: "joe@example.com", name: "joesmith", content: "hello there" }
      ...
      it "does not send out email with invalid inputs" do
        post :create, memorial_id: Memorial.first.slug, message: { email: "joe@example.com", name: "joesmith" }
